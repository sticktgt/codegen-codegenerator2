...
A functional validation check should be executable and should usually have `proposed_file`. Use `validation_intent` only when the check refers to an executable test file:
...
```json
{
  ...
  "type": "api",
  "requirement_id": "REQ-...",
  "scheme_element_id": "api.resource",
  "description": "Verify the required API behavior.",
  "test_method_id": "backend.pytest.api.mutable-state",
  "validation_intent": "extend_existing_test",
  "proposed_file": "backend/tests/test_resource_api.py",
...
```json
{
  "id": "VAL-REQ-...-api-regression",
  "type": "api",
  "requirement_id": "REQ-...",
  "scheme_element_id": "api.resource",
  "description": "Rerun an existing API test to verify preserved behavior still works.",
  "test_method_id": "backend.pytest.api.mutable-state",
...
- `ui_static` checks do not create test files. They are executed by the pipeline's UI static checker. Do not add `validation_intent`, and do not use `create_new_test`, `extend_existing_test`, or behavior test intents for `ui_static`. An omitted field and a field with a `null` value are not interchangeable unless the schema explicitly allows both.
...
```json
{
  "id": "VAL-REQ-...-ui-static",
  "type": "ui_static",
  "requirement_id": "REQ-...",
  "scheme_element_id": "screen.resource-list",
  "description": "Verify that the changed UI element has stable prototype anchors.",
  "test_method_id": "web.ui.static-anchors",
  "proposed_file": null
}
```
...
```json
{
  "id": "VAL-REQ-...-ui-behavior",
  "type": "ui_behavior",
  "requirement_id": "REQ-...",
  "scheme_element_id": "action.change-resource",
  "description": "Verify the changed user-visible flow through the browser.",
  "test_method_id": "web.e2e.playwright.crud-list-search-flow",
  "validation_intent": "create_behavior_test",
  "proposed_file": "frontend/e2e/resource_flow.spec.js",
  "executable_validation": true
}
```
...
- Required phase report files are the durable structured output. See `instructions/core/pipeline-output.md`.
